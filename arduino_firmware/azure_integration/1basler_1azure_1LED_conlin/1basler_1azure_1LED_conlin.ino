...
// Camera trigger pins
int num_cams_TOP = 1;
int basler_trigger_pins_TOP[1] = {5};
int num_cams_BOTTOM = 0;
int basler_trigger_pins_BOTTOM[1] = {10}; // not actually used on Eli's rig
int azure_trigger_pin = 6;
...
void loop()
{
  ...
  // Python sends 4 bytes, which is a long int encoding the number of 
  // Azure sync pulses we should do here.
